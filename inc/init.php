...
function logic_admin_menu() {
    global $wp_admin_bar;

    $menu_id = 'xs';
    $wp_admin_bar->add_menu(array('id' => $menu_id, 'title' => '<i class="icon icon-magic-wand icon-white"></i> XpeedStudio', 'href' => '#'));
    $wp_admin_bar->add_menu(array('parent' => $menu_id, 'title' => 'Theme Settings', 'id' => 'xs-theme-settings', 'href' => admin_url('admin.php?page=fw-settings')));
    $wp_admin_bar->add_menu(array('parent' => 'xs-theme-settings', 'title' => 'Styling', 'id' => 'xs-styling-settings', 'href' => admin_url('admin.php?page=fw-settings#fw-options-tab-styling_settings'), 'meta' => array('title' => 'Change color or fonts')));
    $wp_admin_bar->add_menu(array('parent' => $menu_id, 'title' => 'Extensions', 'id' => 'xs-unyson-extensions', 'href' => admin_url('admin.php?page=fw-extensions')));
}

add_action('admin_bar_menu', 'logic_admin_menu', 2000);